import enum
from sqlalchemy import Column, String, Boolean, ForeignKey, Integer, Numeric, Enum as SAEnum
...
class Driver(Base):
    ...
    # use_alter breaks the circular FK with buses
