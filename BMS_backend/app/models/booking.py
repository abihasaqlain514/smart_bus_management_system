...
class Booking(Base):
    ...
    passenger = relationship("Passenger", back_populates="bookings", lazy="selectin")
    bus = relationship("Bus", back_populates="bookings", lazy="selectin")
    trip = relationship("Trip", back_populates="bookings", lazy="selectin")
    route = relationship("Route", back_populates="bookings", lazy="selectin")
